...
(vi)adds support of auxiliary information that travels along with messages -- this can be used for adding
(vii)meta-data to message or in creating SAPs;
(viii)provides components for common tasks recurring during implementing networking protocols and 
(ix)(de/serialization, arbitration etc.).
%\begin{itemize}
%    \renewcommand \labelitemi{--}
