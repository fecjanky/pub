...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.5\textwidth]{figures_raw/system_sketch.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.5\textwidth]{figures_raw/pdu_queue_imp.png}
...
\begin{figure*}[!htb]
    \centering
    \includegraphics[width=0.95\textwidth]{figures_raw/proto_tx_part_imp.pdf}
...
\begin{figure*}[!htb]
    \centering
    \includegraphics[width=0.95\textwidth]{figures_raw/ether_tst_wave.png}
...
\begin{figure*}[!htb]
    \centering
    \includegraphics[width=0.95\textwidth]{figures_raw/arp_transaction.png}
