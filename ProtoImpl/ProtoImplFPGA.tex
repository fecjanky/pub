...
The designed framework has been implemented in VHDL with having most of the described parameters as generic inputs of the compononents that enables high level of reusability and customization which adds value to the work. Furthermore since the implementation is open source it can be modfied and/or improved easily. 

For the actual synthesis of the VHDL code a Xilinx Virtex 5 FPGA board -- provided by Aitita International Inc. -- called GPlanad has been used with a 1 Gbps Ethernet PHY attachement this constraint fixed multiple of important generic parameters like the data bus width or the clock frequency.The actual implementation and several test cases are availible on \url{https://github.com/fecjanky/protolayer} that was used for verification.

\dots~Overview of the VHDL implementation with focus on reusability and scientific value
...
\begin{figure*}[!htb]
    \centering
    \includegraphics[width=0.9\textwidth]{figures_raw/ether_tst_wave.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.9\textwidth]{figures_raw/arp_transaction.png}
