...
\begin{abstract}
    ...
    performed on the VHSIC Hardware Description Language (VHDL) description itself. The live tests were carried out on the fully implemented application of Address Resolution Protocol(
    ARP)
...
Validation of the Address Resolution Protocol (ARP) module -- that is implemented through the \emph{ProtoLayer} module
