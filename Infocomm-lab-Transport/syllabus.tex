...
After settling the topology and timings and registering the end of simulation procedure the last step is to start the simulation using the command \verb!$ns run!. on line 55.
