...
\textbf{\emph{\nth{1} container}}: the web-server container apache with PHP e.g.: \url{https://hub.docker.com/_/php/}
...
\textbf{\emph{\nth{2}}}:  Modify the php file found here:\url{https://qosip.tmit.bme.hu/foswiki/pub/Meres/DockerFeladatok/index.php.txt} so that it can connect to the database. The resulting php file has to be documented!
