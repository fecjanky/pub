...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Set the home directory on each host (Leecher1-3,Seed) by executing the command `export HOME=/home/p2p/\textless~HOST NAME~\textgreater' from the corresponding xterm window
	\end{enumerate}
\end{enumerate}
