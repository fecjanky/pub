...
Where T\textsubscript{frame} (frame time of the internal time synchronization) is \SI{11.52}{\micro\second} and typical values for the system clock are
...
Substituting these values into \eqref{eq:clkerr} gives that it is $\lfloor 0.072 \rfloor = 0$ clock periods.
