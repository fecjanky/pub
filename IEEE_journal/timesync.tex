...
compared to the replicated stacks as those can have skew to each other as within the boundaries as specified by their protocol.
...
perturbation between the HW implementation -- no OS scheduler, no network \emph{etc.}
