...
Where T\textsubscript{frame} (frame time over the internal synchornization bus) is \SI{5.76}{\micro\second} and typical values for the system clock are
...
Substituting these values into \eqref{eq:clkerr} gives that the skew in terms of clock cycles is $\lfloor 0.072 \rfloor = 0$ clock periods.
