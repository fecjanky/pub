...
The curve fitted on this measurement that there was a fix \SI{14.52}{\micro\second} offset compared to the reference clock. As presented in Section~\ref{sec:Challanges} 
...
time-stamp is 64 bits wide also using the NTP binary fractional representation. Given that the time-stamp is accurate to the last but the theoretical accuracy is \SI{232.83}{\pico\second}.
